...
path_list = [
    ...
    ['logs/f7_epsilon.npy', 'Line 0.3-0.01'],
    ['logs/f6_epsilon.npy', 'J-curve 0.5-0.01'],    
    ['logs/f8_epsilon.npy', 'S-curve 0.2-0.01'],    
    ['logs/f11_epsilon.npy', 'J-curve 0.15-0.01'],
    ['logs/e01_epsilon.npy', 'epsilon 1%'],
    ['logs/e05_epsilon.npy', 'epsilon 5%'],
    ['logs/e15_epsilon.npy', 'epsilon 15%'],
    ['logs/e20_epsilon.npy', 'epsilon 20%'],
