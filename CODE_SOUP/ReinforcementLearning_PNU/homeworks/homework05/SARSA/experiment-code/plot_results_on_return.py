...
path_list = [
    ['logs/e10_on_return.npy', 'epsilon 10%'],
    ['logs/f1_on_return.npy', 'Line 0.9-0.05'],
    ['logs/f2_on_return.npy', 'J-curve 0.99-0.05'],    
    ['logs/f4_on_return.npy', 'S-curve 0.6-0.05'],
    ['logs/f7_on_return.npy', 'Line 0.3-0.01'],
    ['logs/f6_on_return.npy', 'J-curve 0.5-0.01'],    
    ['logs/f8_on_return.npy', 'S-curve 0.2-0.01'],    
    ['logs/f11_on_return.npy', 'J-curve 0.15-0.01'],
    ['logs/e01_on_return.npy', 'epsilon 1%'],
    ['logs/e05_on_return.npy', 'epsilon 5%'],
    ['logs/e15_on_return.npy', 'epsilon 15%'],
    ['logs/e20_on_return.npy', 'epsilon 20%'],
...
plt.legend()
plt.title('Average of Episodic Return (On Learning Policy)')
# plt.plot(x, t_median)
# plt.plot(x, e_median)
# plt.plot(x, f_median)
