...
import logging
logging.basicConfig(filename='logs/m0d1.log', level=logging.INFO, filemode='w')  # filemode='w'
...
while True:
    ...
    for episode in range(EPISODE_LIMIT):
        ...
        while not done:            
            global_step += 1
            print(f'round: {r}. global_step: {global_step}. broken count: {broken_count}. episode: {episode}')
