...
if __name__ == '__main__':
    ...
    root_path = 'datasets/original_dataset1/crowd'
    file_path_list = get_file_path_list(root_path, file_extends=['mp4'])
    vc = VideoClips(
        file_path_list,
        frame_rate=7
    )
    ...
    print(f'{len(vc)=}')
    video_path = 'datasets/original_dataset/crowd/00000801_crowd.mp4'
