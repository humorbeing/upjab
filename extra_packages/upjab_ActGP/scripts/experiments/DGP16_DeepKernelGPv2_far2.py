...
from upjab_ActGP.models.gp_design.gpytorch_DNN_ExactGP_v02 import Get_GP_model
...
def one_train_gpytorch_model(    
    ...
    gp_model = Get_GP_model(x_train, y_train)

    gp_model = gp_model.to(device)

    
    optimizer = torch.optim.Adam([
        {'params': gp_model.model.feature_extractor.parameters()},
        {'params': gp_model.model.covar_module.parameters()},
        {'params': gp_model.model.mean_module.parameters()},
...
config.exp_name = "DGP16_DeepKernelGPv2_far2"
