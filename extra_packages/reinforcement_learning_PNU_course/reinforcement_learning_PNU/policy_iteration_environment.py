...
from reinforcement_learning_PNU import AP
...
class GraphicDisplay(tk.Tk):
    ...
    def load_images(self):
        up = PhotoImage(Image.open(AP("assets/img/up.png")).resize((13, 13)))
        right = PhotoImage(Image.open(AP("assets/img/right.png")).resize((13, 13)))
        left = PhotoImage(Image.open(AP("assets/img/left.png")).resize((13, 13)))
        down = PhotoImage(Image.open(AP("assets/img/down.png")).resize((13, 13)))
        rectangle = PhotoImage(Image.open(AP("assets/img/rectangle.png")).resize((65, 65)))
        triangle = PhotoImage(Image.open(AP("assets/img/triangle.png")).resize((65, 65)))
        circle = PhotoImage(Image.open(AP("assets/img/circle.png")).resize((65, 65)))
